      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-card-foreground/80 leading-relaxed">
            Meeting of the Minds brings together corporate teams and the local
            trivia community for an incredible evening of charity, community,
            and competition. This is the inaugural St. John's city-wide trivia
            championship, featuring expertly hosted rounds that blend pop
            culture, intellectual challenges, and local knowledge.
          </p>
        </div>
