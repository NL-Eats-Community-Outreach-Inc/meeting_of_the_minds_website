...
export const Venue = () => {
    const features = [
        ...
        },
        {
            ...
            title: "Cash Bar",
            description:
                "Refreshments and drinks available throughout the evening",
        },
        {
            icon: Car,
                ...
                <div className="max-w-5xl mx-auto space-y-8">
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-muted-foreground">
                                        A premier venue in the heart of St.
                                        John's with state-of-the-art
                                        audio-visual equipment perfect for our
                                        multimedia trivia rounds.
                                    </p>
                                </div>
                            </div>
                        </CardContent>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {features.map((feature) => (
                            <Card
                                key={feature.title}
                                className="border-border bg-card hover:shadow-elevated transition-all"
                            >
                        ...
                        <CardContent className="p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p className="text-muted-foreground">
                                        Parking available on-site. Additional
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground">
                                        Multiple bus routes service the Signal
                                        Hill area. Check Metrobus schedules for
                                        details.
                                    </p>
                                </div>
                            </div>
