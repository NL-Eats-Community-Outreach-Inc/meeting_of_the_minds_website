          ...
          <Card className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground border-0">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-lg text-primary-foreground/90 mb-6">
                St. John's showed up, and showed just how much this community
                cares. From the first round to the final tiebreaker, this year's
                trivia championships were everything we hoped for and more —
                great teams, tough questions, and an incredible amount of
                goodwill raised for food security right here at home. Thank you
                to every team, sponsor, and supporter who made it happen. Stay
                tuned — the next chapter is already in the works.
              </p>
            </CardContent>
          </Card>
        </div>
